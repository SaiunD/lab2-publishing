    ...
    def add_data(self, table_name, data):
        try:
            ...
            if "duplicate key value" in str(e):
                self.view.show_message(f"ПОМИЛКА: дані з таким ключом вже існують.\nКод помилки: {e.pgcode}.")
            elif "не присутній в таблиці" in str(e):
